<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" xmlns:livewire="lc_voting">
<head>
    <meta charset="utf-8">
        ...
        >
            ...
            @else
                <div class="my-6 text-center">
                    <a
                        href="{{route('login')}}"
                        class="inline-block mt-2 items-center justify-center w-1/2 h-11 text-xs bg-blue text-white font-semibold rounded-xl border border-blue hover:bg-blue-hover transition duration-150 ease-in px-6 py-3"
                    >
                        Login
                    </a>
                    ...
                    <a
                        href="{{route('register')}}"
                        class="inline-block mt-2 items-center justify-center w-1/2 h-11 text-xs bg-gray-200 font-semibold rounded-xl border hover:bg-blue-hover transition duration-150 ease-in px-6 py-3"
                    >
                        Signup
                    </a>
                </div>
